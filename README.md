...
2. Copy the `example.mailer.conf.json` file from the application directory into the `GarminMailer` folder you just created.
3. Rename the copied file to `mailer.conf.json`.
4. Edit the new file and enter your SMTP server details.
