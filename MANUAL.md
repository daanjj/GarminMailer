...
First, download the latest version of the application from the [GitHub Releases page](https://github.com/daanjj/GarminMailer/releases).
...
1. Download the `GarminMailer-Windows.zip` file.
2. Unzip the file. This will create a folder containing `GarminMailer.exe` and an example configuration file.
